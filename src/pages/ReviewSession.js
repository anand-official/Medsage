...
export default function ReviewSession() {
    ...
    if (sessionDone) {
        ...
        return (
            <Box sx={{ maxWidth: 700, mx: 'auto', py: 6, px: 2, textAlign: 'center' }} role="status" aria-live="polite">
                {/* Done hero */}
                <Box sx={{
                ...
                <Typography variant="body1" color="text.secondary" sx={{ mb: 4 }}>
                    {sessionResults.length === 0
                        ? 'Your SM-2 deck is fully reviewed. Come back tomorrow, or create new cards from Cortex after your next study session.'
    ...
    if (loading) {
        return (
            <Box sx={{ maxWidth: 680, mx: 'auto', py: 6, px: 2 }} role="status" aria-live="polite" aria-label="Loading review cards">
                <Typography variant="h5" fontWeight={800} sx={{ mb: 1 }}>
                    Preparing your review deck
                </Typography>
                <Typography color="text.secondary" sx={{ mb: 3 }}>
                    Checking due SM-2 cards and today&apos;s retention signals.
                </Typography>
    ...
    if (error) {
        return (
            <Box sx={{ maxWidth: 680, mx: 'auto', py: 6, px: 2 }} role="alert">
                <Typography variant="h5" fontWeight={800} sx={{ mb: 1 }}>
                    Review deck unavailable
                </Typography>
                <Typography color="text.secondary" sx={{ mb: 3 }}>
                    Medsage could not load your spaced-repetition queue. Your progress is still safe.
                </Typography>
