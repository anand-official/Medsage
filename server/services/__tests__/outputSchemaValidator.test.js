  ...
  test('accepts valid structured payload', () => {
    const raw = JSON.stringify({
      claims: [
        ...
        { statement: 'Third valid medical claim statement.', chunk_ids: ['C3'] }
      ],
